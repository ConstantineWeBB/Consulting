...
Запуск сборки проекта и выгрузка результата на сервер GitHub.
Установить пакет npm install gh-pages.
Заменить в package.json :"deploy": "gulp deployFTP --build", на "deploy": "gh-pages -d dist", и добавить 
